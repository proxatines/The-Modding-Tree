...
Now for the good stuff! Head into [layers.js](/js/layers.js). There is a basic layer already there (although it has a few redundant things in it.) Let's see what it's doing...
